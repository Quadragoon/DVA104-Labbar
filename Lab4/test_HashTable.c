...
/*Typer för att hantera ett dynamiskt antal tabeller*/
typedef struct{
    HashTable table;
    int tableSize;
    int colissions;
...
/*Testfunktioner*/
void compareHashTableSizes(void);/*Välj hur många olika hashtabellsstorlekar du vill jämföra. Lägger in samma data i samtliga storlekar och skriver ut antal krockar med respektive storlek*/
...
/*********************************************************************************************************/
/*Funktioner for meny, testfunktion och for att jamfora krockar for olika storlekar pa hashtabellen*/
/*********************************************************************************************************/
...
void test(void)
{
    ...
    // assert(collisions == 11);; TODO: THIS LINE WAS HERE LIKE THIS
    ...
    //Soker efter person som ligger pa ratt plats och person som ligger annan plats pga krock
            ...
            case 2:
                ...
                switch (subChoice) {
                    ...
                    case 2:
                        ...
                        aPerson.name[sizeof(aPerson.name-1)] = '\0'; //ta bort enterslaget som fgets läser in i strängen - ignorera potentiellt varningsmeddelande
                        printf("Enter weight: ");
