...
/*Typer for att hantera ett dynamiskt antal tabeller - anvands i compareHashTableSizes*/
typedef struct {
	HashTable table;
	int tableSize;
	int collissions;
...
void test(void)
{
	HashTable htable = createHashTable(10); /*En battre storlek for mangden 9 ar 13. Denna funktion (test) ar dock endast till for att testa att hashtabellens funktioner implementerats korrekt och %10 ar lattare for gemene man att berakna an %13.*/
